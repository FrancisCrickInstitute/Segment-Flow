...
def create_argparser_finetune():
    ...
    parser.add_argument(
        "--finetune-config",
        dest="finetune_config",
        default=None,
        help=(
            "Path to a YAML file of model-specific finetune parameters "
            "(generated by the napari plugin from the model's "
            "finetuning_meta_data schema). Optional — script-level defaults "
            "are used for any parameter not present."
        ),
    )
    return parser
